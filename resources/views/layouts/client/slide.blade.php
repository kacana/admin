        ...
        <ul>
            <li data-transition="fade" data-slotamount="13" data-masterspeed="300" >
                ...
                <div class="tp-caption top-label lfl stl"
                     ...
                     data-speed="300"
                     data-start="500"
                     data-easing="easeOutExpo">khai trương website kacana</div>
                ...
                <div class="tp-caption main-label sft stb"
                     ...
                     data-speed="300"
                     data-start="1500"
                     data-easing="easeOutExpo">Giảm giá 10%</div>

                <div class="tp-caption bottom-label-bold sft stb"
                     data-x="160"
                     data-y="271"
                     data-speed="500"
                     data-start="2000"
                     data-easing="easeOutExpo">Trên tất cả sản phẩm</div>
                <div class="tp-caption bottom-label sft stb"
                     data-x="290"
                     data-y="315"
                     data-speed="500"
                     data-start="2800"
                     data-easing="easeOutExpo">( 12/12/2015 - 21/12/2015 )</div>
            </li>
            <li data-transition="fade" data-slotamount="13" data-masterspeed="300" >
